...
class TrafficLight(Actor):
    ...
    def get_info(self):
        ...
        volume_location = self.transfrom_bounding_box_location()
    ...
    def transfrom_bounding_box_location(self):
        trigger_volume = self.carla_actor.trigger_volume
        base_transform = self.carla_actor.get_transform()
        area_loc = base_transform.transform(trigger_volume.location)
        return area_loc
